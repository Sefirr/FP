...
int main() 
{
	...
	string elementoJugador, elementoComputadora, reglasjuego, d, nick;
	...
	ifstream tmpread, regread, reglas;
	ofstream tmpwrite, regwrite;
	
	cout << "Por favor, introduce tu apodo: ";
	cin >> nick;
	
	regread.open("registro.txt");
	tmpwrite.open("tmp.txt");
