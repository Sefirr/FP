...
/* Funciones correspondiendes a leer y guardar los datos en los archivos binarios.
Por eso mismo, cuando se guarda en el archivo binario el parámetro no necesita ampersant ya que no se modifica la estructura.
En cambio, cuando se lee, si se modifica. por eso se usa ampersant. */
